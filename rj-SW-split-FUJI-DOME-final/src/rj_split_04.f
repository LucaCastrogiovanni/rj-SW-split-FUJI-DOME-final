...
c         obs_D(i,2)= CO2 of the i-th event
c         obs_D(i,3)= error on CO2 for the i-th event
c
c--------------------------------------------------------------------------------------------
c
...
c  to a given point determines the DT and THETA in that point, i.e.:
c
c    syn_D(i,1)=CO2_near, where CO2_near is the CO2 for the nearest nucleus to obs(i,1)
c
c---------------------------------------------------------------------------------------------
c
c  The model:
...
c
c     param -- time, BETA, GAMM : t- coord, BETA and GAMMA are splitting params for each nucleus
...
c
c   4. Compute Misfit between observed and predicted DT and THETA
c
